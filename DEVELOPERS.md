...
Rooster uses a point-based scoring system to link installed plugins to Thunderstore packages. To be successfully discovered, a mod must accumulate **at least 60 points**.
