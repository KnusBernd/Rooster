...
-   **Integrity Verification**: Every downloaded update is verified against its **SHA256 hash** provided by Thunderstore. If the download is corrupted or tampered with, the installation is aborted immediately.
